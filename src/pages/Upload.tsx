  ...
  return (
    <div className="min-h-screen pt-24 pb-16">
      <div className="container mx-auto px-4 max-w-2xl">
        ...
        {/* Upload Area */}
        <div
          className={`glass rounded-2xl p-10 text-center transition-all duration-300 animate-fade-in-up ${
            isDragging ? "border-primary border-2 bg-primary/10" : "border-dashed border-2 border-border"
          }`}
        ...
        <div className="mt-8 text-center animate-fade-in-up" style={{ animationDelay: "200ms" }}>
          <Button
            ...
            className="gradient-primary hover:opacity-90 transition-opacity text-lg px-12 py-6 w-full md:w-auto"
          >
            {isAnalyzing ? (
              <>
